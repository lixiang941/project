...
<body>
    <form id="form1" runat="server" action="action.php?a=dologin" method="post">
    <div class="Main">
        <ul>
            <li class="top"></li>
            <li class="top2"></li>
            ...
            <li class="middle_C"><span class="btn"><input  type="image" src="images/login/btnlogin.gif" /></span></li>
