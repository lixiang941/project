...
include '../init.php';
$id =$_GET['id'];
$sql="SELECT id,name,password,role,`lock` FROM ".PRE."user WHERE id={$id}";
$user = query($link,$sql);
?>
<html>
<head>
  ...
  <tr>
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="main-tab">
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <input type="text"  value="<?php echo $user[0]['name']?>"  class="text-word" >
        </td>
        </tr>
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
      ...
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <option value="0" <?php echo $user[0]['role']==0?'selected':''?> >&nbsp;&nbsp;普通用户</option>
	    <option value="1" <?php echo $user[0]['role']==1?'selected':''?>>&nbsp;&nbsp;管理员</option>
	    <option value="2" <?php echo $user[0]['role']==2?'selected':''?> >&nbsp;&nbsp;超级管理员</option>
        </select>
        </td>
      </tr>
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
