...
//$sql="SELECT id,name,path,concat(path,id,',') as bpath FROM ".PRE."category ORDER BY path";
...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
 ...
 <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td align="left" valign="middle" class="borderright borderbottom main-for">
        <label><input type="radio" name="status"  value="1" checked class=""> 上架</label>
       <label> <input type="radio" name="status"  value="0" class=""> 下架</label>
        </td>
      </tr>
<tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <td align="right" valign="middle" class="borderright borderbottom bggray">是否热销：</td>
        <td align="left" valign="middle" class="borderright borderbottom main-for">
        <label><input type="radio" name="is_hot"  value="1" checked class=""> 热</label>
       <label> <input type="radio" name="is_hot"  value="0" class="">凉</label>
        </td>
      </tr>
<tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <td align="right" valign="middle" class="borderright borderbottom bggray">是否新品：</td>
        <td align="left" valign="middle" class="borderright borderbottom main-for">
        <label><input type="radio" name="is_new"  value="1" checked class=""> 新品</label>
       <label> <input type="radio" name="is_new"  value="0" class="">废品</label>
        </td>
      </tr>
<tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <td align="right" valign="middle" class="borderright borderbottom bggray">是否精品：</td>
        <td align="left" valign="middle" class="borderright borderbottom main-for">
        <label><input type="radio" name="is_best"  value="1" checked class="">精品</label>
       <label> <input type="radio" name="is_best"  value="0" class="">有瑕疵</label>
        </td>
      </tr>
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
