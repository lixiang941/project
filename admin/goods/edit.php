...
$gid= $_GET['gid'];
$sql ="SELECT id,name,cate_id,price,stock,`describe` FROM ".PRE."goods WHERE id={$gid}";
$goods =query($link,$sql);
//goodsvar_dump($goods);
?>
...
<table width="99%" border="0" cellspacing="0" cellpadding="0" id="searchmain">
  ...
  <tr>
    ...
    <td align="right" valign="middle" class="borderright borderbottom bggray">商品名称：</td>
        ...
        <input type="text" name="name" value="<?php echo $goods[0]['name']?>"  class="text-word">
        </td>
        </tr>
  ...
  <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        ?>
        <option value="<?php echo $value['id']?>" <?php echo $value['id']==$goods[0]['cate_id']?'selected':''?> >&nbsp;&nbsp;<?php echo $space.$value['name']?></option>
      ...
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td align="left" valign="middle" class="borderright borderbottom main-for">
        <input type="text" name="price" value="<?php echo $goods[0]['price']?>"  class="text-word">
        </td>
        </tr>
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        <td align="right" valign="middle" class="borderright borderbottom bggray">商品库存：</td>
        <td align="left" valign="middle" class="borderright borderbottom main-for">
        <input type="text" name="stock"  value="<?php echo $goods[0]['stock']?>"class="text-word">
        </td>
      </tr>
      ...
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
        ...
        <td align="left" valign="middle" class="borderright borderbottom main-for">
        <textarea name="describe" rows="5" cols="50"><?php echo $goods[0]['describe']?></textarea>
        </td>
      </tr>
      <tr onMouseOut="this.style.backgroundColor='#ffffff'" onMouseOver="this.style.backgroundColor='#edf5ff'">
